...
# JJKirn 2/8/2020
#
# Modifed version of scan_lan2.py to output comma-seperated data to file (data.txt)
# File (data.txt) is designed to be an input to program text_table.py 
#  to create a web page version of scan_lan2.py output.
#
   ...
   with open (fpath) as f:
      ...
      for line in f:
         ...
         try:
            ...
            print('Bad Line - {0} in file {1}' .format(cnt, fpath) )
...
#
#
print('Number of MAC addresses read in = {0}' .format(cnt) )
